...
const dataExp = [
    {
        ...
        usedTech: "- Thiết kế hệ thống dịch vụ cho thuê ERP trên nền tảng Cloud Native đảm bảo tính mở rộng, bảo mật và sẵn sàng cao, chịu tải cao",
        descripttion1: "- Làm việc với API các dịch vụ hệ thống để phát triển các tính năng tự động hóa",
        descripttion2: "- Nghiên cứu và nâng cấp bảo mật cho các luồng tự động hóa",
        descripttion3: "- Đề xuất triển khai giải pháp IPS/IDS, các phương án vận hành automation trên nền tảng containerizing",
        descripttion4: "- Lên kịch bản giám sát, đánh giá và cải tiến hệ thống dựa trên các tiêu chuẩn Benmark",
        descripttion4: "- Đề xuất và triển khai giải pháp kỹ thuật phù hợp với mục tiêu của khối CNTT",
        line: "",
    ...
    },
    {
        ...
        link: "https://vnpay.vn",
        usedTech: "- Vận hành và quản trị nhiều máy chủ load balacing(Topup billing, EFIN, các kết nối tới bank,....",
        descripttion1: "- Tham gia triển khai cài đặt hệ thống DR (Topup Billing service, OTP service)",
        descripttion2: "- Viết tool cài đặt phần mềm cho nhiều server",
        descripttion3: "- Nghiên cứu xây dựng giải pháp CI/CD Automation áp dụng vận hành, quản trị cho Windows Server AD ",
        line: "",
    ...
    },
    {
        ...
        times: "7/2021 -  10/2023",
        link: "https://isofh.com",
        usedTech: "- Thiết kế vẽ mô hình kiến trúc hệ thống khi có dự án  ",
        ...
        descripttion2: "- Xây dựng và triển khai giải pháp giám sát hệ thống tập trung ~500 server",
        descripttion3: "- Cài đặt, sửa chữa và tối ưu Jenkins CI/CD cho các dự án đang chạy",
        descripttion4: "- Xây dựng hệ thống tự động triển khai hệ thống máy chủ dự án trên Ansible và Jenkins ",
        descripttion6: "- Tuning, Hardening OS tinh chỉnh cấu hình dịch vụ (Load Balancing, Queue, Cache..) các chuẩn Benchmark ",
        descripttion7: "- Chuyển ứng dụng HIS/EMR qua môi trường kubernetes, nâng cấp chuyển đổi CICD sang mô hình GitOps",
        line: "4",
        position: "Devops Engineer",
    },
    {
        ...
        descripttion4: "- Làm việc với các dịch vụ EC2 , ECS, Glacier , S3 , EFS , EBS , ELB , VPC , CloudWatch , IAM trên cloud AWS",
