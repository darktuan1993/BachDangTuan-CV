const dataExp = [
    ...
    },
    {
        ...
        descripttion2: "- Build and deploy system monitoring solutions with Prometheus & Grafana technology, Loki Log centralized management.",
        descripttion3: "- Installation, repair and optimization of Jenkins CI/CD for projects.",
        ...
        descripttion6: "- Tuning, Hardening OS Linux (Ubuntu, Redhat), tweaking service configuration (Nginx, Haproxy, Redis, RabbitMQ,..), Install and configure Postgres Database (Master-Slaves), Operate and administer Jira, Confluence, Gitlab local systems.",
    ...
    },
    {
        ...
        usedTech: "",
        descripttion:  "- Managing source code servers SVN Server, Gitlab Server.",
